...
SELECT date_trunc('day', confirmed_at)           AS block_date,
       SUM(CASE
               WHEN to_id = wallet('0x6238872A0Bd9F0E19073695532a7Ed77ce93C69E') THEN cast(value as decimal(38, 18))
               ELSE 0 END)                       AS in_amt,
       SUM(CASE
               WHEN from_id = wallet('0x6238872A0Bd9F0E19073695532a7Ed77ce93C69E') THEN cast(value as decimal(38, 18))
